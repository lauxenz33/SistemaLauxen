 ...
 * @author mhscm
 */
public class JDlgDslUsuarios extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(JDlgDslUsuarios.class.getName());

    /**
     * Creates new form JDlgDslUsuarios
     */
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                JDlgDslUsuarios dialog = new JDlgDslUsuarios(new javax.swing.JFrame(), true);
