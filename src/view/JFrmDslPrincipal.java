 ...
 * @author mhscm
 */
public class JFrmDslPrincipal extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(JFrmDslPrincipal.class.getName());

    /**
     * Creates new form JFrmDslPrincipal
     */
    public JFrmDslPrincipal() {
        initComponents();
        setTitle("Sistema de Vendas de Computadores - Início");
    ...
    private void jMnuUsuariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMnuUsuariosActionPerformed
      ...
      JDlgDslUsuarios dialog = new JDlgDslUsuarios(this, true);
dialog.setVisible(true);
    ...
    private void jMnuClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMnuClientesActionPerformed
        // TODO add your handling code here:
         JDlgDslClientes dialog = new JDlgDslClientes(this, true);
dialog.setVisible(true);
    ...
    private void jMnuFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMnuFornecedorActionPerformed
        // TODO add your handling code here:
          JDlgDslFornecedor dialog = new JDlgDslFornecedor(this, true);
dialog.setVisible(true);
    ...
    private void jMnuProdutosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMnuProdutosActionPerformed
        // TODO add your handling code here:
          JDlgDslProdutos dialog = new JDlgDslProdutos(this, true);
dialog.setVisible(true);
    ...
    private void jMnuLicencasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMnuLicencasActionPerformed
        // TODO add your handling code here:
          JDlgDslSistemaOs dialog = new JDlgDslSistemaOs(this, true);
dialog.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new JFrmDslPrincipal().setVisible(true));
    }
